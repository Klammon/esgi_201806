...
public class LocalContexts {
     ...
     */
    public String getCac40Path() {
        return getClass().getClassLoader().getResource("cac40.csv").getFile();
    }
     ...
     */
    public String getSGPath() {
        return getClass().getClassLoader().getResource("soge.csv").getFile();
    }
